...
global $evento_atual;
global $penultimo_evento;

$evento_atual = new WP_Query( array(
    'post_type' => 'evento',
    'posts_per_page' => 1,
    'order' => 'DESC',
    'meta_query'    => array(
...
$penultimo_evento = new WP_Query( array(
    'post_type' => 'evento',
    'posts_per_page' => 1,
    'order' => 'DESC',
    'offset' => 1
...
function my_search_form($form)
{
    ...
    $form = '<form id="search" action="'.home_url("/") .'" method="POST">
        <div class="searchbar">
            <input type="hidden" name="post_type" value="post" />
            <input class="d-block input flex-fill" placeholder="Busca" id="s" name="s" type="text" value="' . get_search_query() . '" />
